...
[🔗 LinkedIn](https://www.linkedin.com/in/nikkonakov/)
...
**🎨 Frontend:** React, React Native, Next.js, Expo, Tailwind CSS, NativeWind  
**🗄️ Backend & Database:** Firebase (Authentication, Firestore, Cloud Functions), SQL, Database Design  
**🔧 Tools & Platforms:** Git/GitHub, Docker 🐳, CI/CD, Expo Router, REST APIs  
**🚀 Development Practices:** OOP, Design Patterns, Unit Testing (JUnit, Jest), Agile/Scrum, UML

---

## 📱 Projects

### 🚴‍♂️ TrackPeloton - Fitness Tracking Mobile Application  
...
- 🤖 Designed and deployed a CI/CD pipeline for automated testing and deployment workflows
- 🧑‍💻 Established the project structure, coding standards, and development practices for team collaboration
